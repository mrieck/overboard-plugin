...
TOOLS = [
    ...
    ("record_digest", "Record the live PM digest: narrative (one sentence: what's happening now) and review (0-4 specific things a human should check). Call after reading the project's new events.", {"project": _S, "narrative": _S, "review": {"type": "array", "items": _S}}, ["project", "narrative"], record_digest),
    ...
    ("flag_for_review", "Flag something for the human to review on the dashboard. project may be a group name or a repo slug; note is one specific thing to check.", {"project": _S, "note": _S}, ["project", "note"], flag_for_review),
